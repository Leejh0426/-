...
#define PA9_USART_TX_FTDI_RX_Pin GPIO_PIN_9
#define PA9_USART_TX_FTDI_RX_GPIO_Port GPIOA
#define PA10_USART_RX_FTDI_TX_Pin GPIO_PIN_10
#define PA10_USART_RX_FTDI_TX_GPIO_Port GPIOA
